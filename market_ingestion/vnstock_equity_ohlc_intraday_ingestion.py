...
def main():
    ...
    print("=" * 80)
    print("Fetch VNStock Equity Intraday OHLCV → MinIO S3 (Parquet, partitioned)")
    print("=" * 80)
    symbol_source = (
    ...
    print(f"Target output     : s3://{market_prefix}/equity/year=YYYY/month=MM/day=DD/ohlc.parquet")
    ...
    print("\n" + "=" * 80)
    logger.info("🎉 Intraday OHLCV ingestion complete!")
    print("=" * 80)
